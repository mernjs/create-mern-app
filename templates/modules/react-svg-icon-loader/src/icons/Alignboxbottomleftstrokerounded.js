...
const Alignboxbottomleftstrokerounded = ({ size = 24, color = '#000000' }) => (
    ...
    <path d="M15 12L7 12M10 17H7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
);
export default Alignboxbottomleftstrokerounded;
