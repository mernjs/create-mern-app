...
const Alignboxbottomrightstrokerounded = ({ size = 24, color = '#000000' }) => (
    ...
    <path d="M17 12L9 12M17 17H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
);
export default Alignboxbottomrightstrokerounded;
