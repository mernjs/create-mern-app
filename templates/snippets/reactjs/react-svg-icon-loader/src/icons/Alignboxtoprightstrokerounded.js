...
const Alignboxtoprightstrokerounded = ({ size = 24, color = '#000000' }) => (
    ...
    <path d="M17 7L9 7M17 12H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
);
export default Alignboxtoprightstrokerounded;
