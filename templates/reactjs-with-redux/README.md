...
| ------ | ------ | ------ | ------ | ------ |
| 1 | MERN With MongoDB | @reduxjs/toolkit axios body-parser cors dotenv ejs express faker history lodash mongoose next next-pwa next-redux-wrapper react react-dom react-icons react-redux react-toastify redux redux-form redux-logger redux-persist redux-saga styled-components | [Click Here](https://bit.ly/mern-full-setup) | [Watch Here](https://www.youtube.com/playlist?list=PLdb4nm44DkLpdb1Oj60C-G2AegIsOCYhU) |
| 2 | MERN With MySQL | @reduxjs/toolkit axios body-parser cors dotenv ejs express faker history lodash mysql sequelize next next-pwa next-redux-wrapper react react-dom react-icons react-redux react-toastify redux redux-form redux-logger redux-persist redux-saga styled-components | [Click Here](https://bit.ly/mern-full-setup) | [Watch Here](https://www.youtube.com/playlist?list=PLdb4nm44DkLonYF_tXGbw1uD7SYEjUtlS) |
| 3 | NodeJS With MongoDB | body-parser cors dotenv ejs express faker lodash mongoose morgan | [Click Here](https://mernjs-nodejs-mongodb.herokuapp.com/) | [Watch Here](https://www.youtube.com/playlist?list=PLdb4nm44DkLqpBOBoir1ggnz4VKcq4W4M) |
| 4 | NodeJS With MySQL | body-parser cors dotenv ejs express faker lodash mysql sequelize morgan | [Click Here](https://mernjs-nodejs-mongodb.herokuapp.com/) | [Watch Here](https://www.youtube.com/playlist?list=PLdb4nm44DkLrvvwalY_iHT3ff8L13es_c) |
| 5 | NextJS With Redux | @reduxjs/toolkit axios history lodash next next-redux-wrapper react react-dom react-icons react-redux react-toastify redux redux-form redux-logger redux-persist redux-saga styled-components | [Click Here](https://mernjs-nextjs.herokuapp.com) | [Watch Here](https://www.youtube.com/playlist?list=PLdb4nm44DkLrPA8WrN2tXNJuphIYybShv) |
| 6 | ReactJS With Redux | @reduxjs/toolkit @testing-library/jest-dom @testing-library/react @testing-library/user-event axios history react react-dom react-icons react-redux react-router-dom react-scripts react-toastify redux redux-form redux-logger redux-persist styled-components web-vitals workbox-background-sync workbox-broadcast-update workbox-cacheable-response workbox-core workbox-expiration workbox-google-analytics workbox-navigation-preload workbox-precaching workbox-range-requests workbox-routing workbox-strategies workbox-streams  | [Click Here](https://mernjs-reactjs.herokuapp.com) | [Watch Here](https://www.youtube.com/playlist?list=PLdb4nm44DkLoXnXvjCBUxIwJlE1nB49TS) |
| 7 | ReactJS With Context API | @reduxjs/toolkit @testing-library/jest-dom @testing-library/react @testing-library/user-event axios history react react-dom react-icons react-redux react-router-dom react-scripts react-toastify styled-components web-vitals workbox-background-sync workbox-broadcast-update workbox-cacheable-response workbox-core workbox-expiration workbox-google-analytics workbox-navigation-preload workbox-precaching workbox-range-requests workbox-routing workbox-strategies workbox-streams  | [Click Here](https://mernjs-reactjs.herokuapp.com) | [Watch Here](https://www.youtube.com/playlist?list=PLdb4nm44DkLojFB5I5aMhOyLBOGkuzUqv) |
| 8 | ElectronJS With Redux | @reduxjs/toolkit @testing-library/jest-dom @testing-library/react @testing-library/user-event axios history react react-dom react-icons react-redux react-router-dom react-scripts react-toastify redux redux-form redux-logger redux-persist styled-components web-vitals workbox-background-sync workbox-broadcast-update workbox-cacheable-response workbox-core workbox-expiration workbox-google-analytics workbox-navigation-preload workbox-precaching workbox-range-requests workbox-routing workbox-strategies workbox-streams  | [Click Here](https://mernjs-reactjs.herokuapp.com) | [Watch Here](https://www.youtube.com/playlist?list=PLdb4nm44DkLr8wz6fM1jZ3Xgc_iEk7gOo) |
