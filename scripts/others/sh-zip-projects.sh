...
parent_directory="/Users/vijaypratapsingh/Desktop/create-mern-app/templates/others"

# Define the directory where the zip files will be stored
zip_directory="/Users/vijaypratapsingh/Desktop/create-mern-app/zip/others"
