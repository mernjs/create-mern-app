...
echo "Ensuring templates/boilerplates/app/sh-upgrade-projects.sh is executable..."
chmod +x templates/boilerplates/app/sh-upgrade-projects.sh
check_last_command

echo "Running templates/boilerplates/app/sh-upgrade-projects.sh to upgrade dependencies..."
(cd templates/app && sh sh-upgrade-projects.sh)
check_last_command

# Step 2: Run the sh-install-projects.sh script to install dependencies
echo "Ensuring templates/boilerplates/app/sh-install-projects.sh is executable..."
chmod +x templates/boilerplates/app/sh-install-projects.sh
check_last_command

echo "Running templates/boilerplates/app/sh-install-projects.sh to install dependencies..."
(cd templates/app && sh sh-install-projects.sh)
check_last_command

# Step 3: Run the sh-start-projects.sh script to start the project
echo "Ensuring templates/boilerplates/app/sh-start-projects.sh is executable..."
chmod +x templates/boilerplates/app/sh-start-projects.sh
check_last_command

echo "Running templates/boilerplates/app/sh-start-projects.sh to start the project..."
