...
const Alignboxmiddlerightstrokerounded = ({ size = 24, color = '#000000' }) => (
    ...
    <path d="M17 9.5L9 9.5M17 14.5H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
);
export default Alignboxmiddlerightstrokerounded;
