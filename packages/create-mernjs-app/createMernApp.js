...
function init() {
    ...
    .on(Constants.help, () => {
        let message = `   Create MERN App provides PWA architecture for building web, mobile and desktop apps in JavaScript. ${chalk.cyan('https://mernjs.github.io/create-mern-app')}`;
