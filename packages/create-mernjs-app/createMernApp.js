...
function init() {
    ...
    .on(Constants.help, () => {
        let message = `   Create MERN App provide boilerplates for building Web App, Mobile App, Desktop App, AR/VR App & Chrome Extension in JavaScript. ${chalk.cyan('https://mernjs.github.io/create-mern-app')}`;
