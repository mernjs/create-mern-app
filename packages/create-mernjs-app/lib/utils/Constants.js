...
Constants.select_form = [
  {
    ...
    choices: ['MERN Boilerplate', 'NodeJS Boilerplate', 'NextJS Boilerplate', 'ReactJS Boilerplate', 'ElectronJS Boilerplate', 'React Native Boilerplate', 'ReactJS Webpack Boilerplate', 'ReactJS Chrome Extension Boilerplate']
