...
const Alignboxmiddlecenterstrokerounded = ({ size = 24, color = '#000000' }) => (
    ...
    <path d="M16 9.5L8 9.5M13.5 14.5H10.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
);
export default Alignboxmiddlecenterstrokerounded;
