...
const Albumnotfound01strokerounded = ({ size = 24, color = '#000000' }) => (
    ...
    <path d="M5 17C6.8176 14.6361 8.72306 12.4166 11 11M18 11.5443C16.7483 10.5786 15.5868 10.1046 14.5 10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
    <path d="M2 2L22 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
);
export default Albumnotfound01strokerounded;
