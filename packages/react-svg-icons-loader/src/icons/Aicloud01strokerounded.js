...
const Aicloud01strokerounded = ({ size = 24, color = '#000000' }) => (
    ...
    <path d="M10.5 20V22M13.5 20V22M10.5 12V14M13.5 12V14M9 15.5H7M9 18.5H7M17 15.5H15M17 18.5H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
);
export default Aicloud01strokerounded;
