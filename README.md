...
| ------ | ------ | ------ |
| NodeJs MongoDB | body-parser cors dotenv ejs express faker lodash mongoose morgan | [Click Here](https://mernjs-nodejs.herokuapp.com) |
| NodeJs MySQL | body-parser cors dotenv ejs express faker lodash mysql sequelize sequelize-cli morgan | [Click Here](https://mernjs-nodejs.herokuapp.com) |
