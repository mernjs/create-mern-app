...
| SN. | Technology | Dependencies | Live Demo |
| ------ | ------ | ------ | ------ |
...
| 3 | NodeJS With MongoDB | body-parser cors dotenv ejs express faker lodash mongoose morgan | [Click Here](https://mernjs-nodejs-mongodb.herokuapp.com/) |
| 4 | NodeJS With MySQL | body-parser cors dotenv ejs express faker lodash mysql sequelize morgan | [Click Here](https://mernjs-nodejs-mongodb.herokuapp.com/) |
| 5 | NextJS With Redux | @reduxjs/toolkit axios history lodash next next-redux-wrapper react react-dom react-icons react-redux react-toastify redux redux-form redux-logger redux-persist redux-saga styled-components | [Click Here](https://mernjs-nextjs.herokuapp.com) |
