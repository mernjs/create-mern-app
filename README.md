...
MERN Stack Boilerplate provide 36 types of starter kits along with typescript for building web and mobile apps in pure JavaScript, released as free and open-source software under the MIT License [MERN Docs](https://mernjs.org).
